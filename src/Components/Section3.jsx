  ...
  return (
    <div className="bg-[#fdf1f0] py-10 px-3 sm:px-8 lg:px-12 overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* LEFT BOX */}
        <div className="bg-[#D01A2D] rounded-xl flex flex-col gap-6 p-4 w-full lg:w-[300px] h-auto lg:h-80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 flex-1">
          {/* Birthday Cake */}
          <div className="relative bg-[#FFD5D5] rounded-xl h-60 flex items-center justify-start shadow-lg px-4 py-3 overflow-visible">
          ...
          {/* Donut */}
          <div className="relative bg-[#E53894] rounded-xl h-60 flex items-center justify-start shadow-lg px-4 py-3 overflow-visible">
            <div className="text-left w-full z-10 pr-12 sm:pr-14 md:pr-16">
