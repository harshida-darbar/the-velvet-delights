      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <button className="bg-[#D9526B] hover:bg-[#c13f5e] cursor-pointer text-white font-medium rounded-full px-5 py-2 transition">
              Order Now
            </button>
          </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 shadow-md">
          <nav className="flex flex-col space-y-3 px-6 py-3">
            <Link to="/" onClick={() => setMenuOpen(false)} className="text-[#D9526B] font-medium">
              Home
            </Link>
            <Link to="/products" onClick={() => setMenuOpen(false)} className="text-gray-700 font-medium">
              Products
            </Link>
            <Link to="/menu" onClick={() => setMenuOpen(false)} className="text-gray-700 font-medium">
              Menu
            </Link>
            <Link to="/about" onClick={() => setMenuOpen(false)} className="text-gray-700 font-medium">
              About
            </Link>
            <Link to="/contact" onClick={() => setMenuOpen(false)} className="text-gray-700 font-medium">
              Contact
            </Link>
            <button className="bg-[#D9526B] hover:bg-[#c13f5e] text-white cursor-pointer rounded-full px-5 py-2 font-medium transition">
              Order Now
            </button>
          </nav>
        </div>
