...
function Footer() {
  return (
    <footer className='bg-white'>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-16 px-8'>
        ...
        <div>
          <h1 className='text-[#E53894] text-2xl mb-5 text-center sm:text-left'>Quick Links</h1>
          <ul className='flex flex-col gap-2  text-gray-700 font-medium text-center sm:text-left '>
            <li>
        ...
        <div>
          <h1 className='text-[#E53894] text-2xl mb-5 text-center sm:text-left'>Stay In Touch</h1>
          <ul className='flex flex-col gap-2 text-gray-700 font-medium text-center sm:text-left'>
            <li>Facebook</li>
            <li>Instagram</li>
            <li>Whatsapp</li>
        ...
        <div>
          <h1 className='text-[#E53894] text-2xl mb-5 text-center sm:text-left'>Shops</h1>
          <ul className='flex flex-col gap-2 text-gray-700 font-medium text-center sm:text-left'>
            <li>Ahmedabad</li>
            <li>Baroda</li>
            <li>Surat</li>
      ...
      <div className='flex flex-col md:flex-row justify-between items-center py-6 px-8 gap-4'>
        ...
        <div className='flex gap-6'>
          <Link to="/privacy" className='text-gray-700 font-medium hover:text-[#c13f5e]'>Privacy</Link>
          <Link to="/terms" className='text-gray-700 font-medium hover:text-[#c13f5e]'>Terms</Link>
        </div>
      </div>
    </footer>
  )
